import Hero from "@/components/pages/BlogInfo/Hero";
import BlogContent from "@/components/pages/BlogInfo/BlogContent";
import RelatedBlogs from "@/components/pages/BlogInfo/RelatedBlogs";
