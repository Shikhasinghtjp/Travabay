...
import styles from "../../styles/BlogInfo/BlogContent.module.css";
      ...
      <aside className={styles.sidebar}>
        ...
        <div className={styles.sidebarCard}>
          ...
          <ul className={styles.relatedList}>
            <li><a href="/blogs/khai-dinh-tomb">Khai Dinh Tomb</a></li>
            <li><a href="/blogs/po-nagar-cham-towers">Po Nagar Cham Towers</a></li>
          </ul>
        </div>
      </aside>
    </div>
